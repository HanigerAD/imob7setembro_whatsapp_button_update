...
export class CityController {
    ...
    public insert(@Body() request: CityRequest): Promise<number> {
    ...
    public getNeightborhoods(@Param('code') code: number): Promise<NeighborhoodResponse[]> {
        return this.service.getNeighborhoods(code);
    }

    @Get(':code')
    public getSingle(@Param('code') code: number): Promise<CityResponse> {
    ...
    public update(@Param('code') code: number, @Body() request: CityRequest): Promise<number> {
