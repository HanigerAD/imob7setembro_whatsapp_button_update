...
export class PropertyService {
    ...
    public getAllProperties(filter: PropertyFilterRequest, res: Response): Promise<any> {
    ...
    public deleteImages(paths: string[]): void {
        Promise.all(paths.map(path => this.repository.deleteImage(path)));
    }

    public deleteDocuments(paths: string[]): void {
